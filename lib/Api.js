...
class Api extends Homey.SimpleClass {
    ...
    static SolutionsRingsPrd = 'prd-api-us.prd.rings.solutions';
    ...
    getMode(location_id) {
        return new Promise((resolve, reject) => {
            this._https('GET', Api.SolutionsRingsPrd, '/api/v1/mode/location/' + location_id, null, false, (error, result) => {
                if (error) {
                    console.log(error);
                    reject(error);
                }
    ...
    enableMode(location_id) {
        return new Promise((resolve, reject) => {
            ...
            this._https('POST', Api.SolutionsRingsPrd, '/api/v1/mode/location/' + location_id + '/settings/setup', null, false, (error, result) => {
                if (error) {
                    console.log(error);
                    reject(error);
                }
    ...
    disableMode(location_id) {
        return new Promise((resolve, reject) => {
            this._https('DELETE', Api.SolutionsRingsPrd, '/api/v1/mode/location/' + location_id + '/settings', null, false, (error, result) => {
                if (error) {
                    console.log(error);
                    reject(error);
                }
    ...
    setMode(location_id, value) {
        return new Promise((resolve, reject) => {
            ...
            this._https('POST', Api.SolutionsRingsPrd, '/api/v1/mode/location/' + location_id, modeData, false, (error, result) => {
                if (error) {
                    console.log(error);
                    reject(error);
                }
