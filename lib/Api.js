...
class Api extends Homey.SimpleClass {
    ...
    async setMode(location_id, value) {   
        ...
        console.log('setMode', 'supportsLocationModeSwitching', supportsLocationModeSwitching, 'hasAlarmBaseStation|hasHubs', location.hasAlarmBaseStation, location.hasHubs);
